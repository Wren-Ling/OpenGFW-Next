...
install -d -m 0755 "$CONFIG_DIR/fingerprints"
...
install -m 0644 "$REPO_ROOT/examples/fingerprints/"*.yaml "$CONFIG_DIR/fingerprints/"
install -m 0644 "$REPO_ROOT/examples/fingerprints/README.md" "$CONFIG_DIR/fingerprints/README.md"
