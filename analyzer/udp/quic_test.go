...
func TestQuicStreamParsing_ClientHello(t *testing.T) {
	...
	want := analyzer.PropMap{
		"ja3":                "771,4865-4866-4867,0-10-16-13-51-45-43-57,29-23-24,",
		"ja3_hash":           "f75253b5e2b4dcb3fdae9b78ce8c6e49",
		"ja4":                "q13d0308p0_55b375c5d22e_f0736a66fa6b",
		"alpn":               []string{"ping/1.0"},
		"cipher_count":       3,
		"ciphers":            []uint16{4865, 4866, 4867},
		"compression":        []uint8{0},
		"ech":                false,
		"extension_types":    []uint16{0, 10, 16, 13, 51, 45, 43, 57},
